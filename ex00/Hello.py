...
# - adds / deletes / modify an item. Mutable containers include dict, list, bytearray and set.
# Immutable containers include frozenset, tuple, string...
# An immutable object can’t be changed after it is created.
# Accessig item[x] in a tuple would raise TypeError: 'tuple' object does not support item assignment.
